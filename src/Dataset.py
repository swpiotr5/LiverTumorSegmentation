...
class Dataset():
    def __init__(self, base_dir="../data/prepared", transformation=None, data_type = ['liver', 'liver_tumor', 'tumor']):
        self.images = []
        self.masks = []
        self.transformation = transformation
        self.data_type = data_type

        for person_dir in sorted(os.listdir(base_dir)):
            if "person" in person_dir:
